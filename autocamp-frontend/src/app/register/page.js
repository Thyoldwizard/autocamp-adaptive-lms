...
function VisualPanel() {
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(112deg,rgba(17,43,33,0.98)_0%,rgba(45,106,79,0.84)_48%,rgba(244,162,97,0.44)_100%)]" />
  ...
  return (
    <main className="min-h-screen bg-background lg:grid lg:grid-cols-[1.04fr_0.96fr]">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-5 py-10 sm:px-8 lg:px-12">
        ...
        <div className="absolute right-[-140px] top-[-120px] h-[340px] w-[340px] rounded-full bg-accent/20 blur-3xl" />
